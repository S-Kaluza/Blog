...
const ListItem = ({ language, description, id }) => {
  return (
    <>
      <StyledListElement
        pos={id % 2 == 0}
      ...
      >
        <ListElementImgame src="https://picsum.photos/200/300" alt="" width={'200px'} height={'125px'} pos={id % 2 == 0} />
        <ListElementDataContainer pos={id % 2 == 0}>
          <ListElementHeader pos={id % 2 == 0}>{language}</ListElementHeader>
